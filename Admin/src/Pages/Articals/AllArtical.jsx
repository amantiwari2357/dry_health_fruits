...
const AllArtical = () => {
    ...
    useEffect(() => {
        const fetchArticles = async () => {
            setIsLoading(true);
            try {
                const response = await axios.get('https://goyat-dryfruits.onrender.com/api/all-articals');
    ...
    const handleDelete = async (articleId) => {
        try {
            ...
            if (result.isConfirmed) {
                await axios.delete(`https://goyat-dryfruits.onrender.com/api/delete-artical/${articleId}`);

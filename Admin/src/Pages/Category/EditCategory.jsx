...
const EditCategory = () => {
    ...
    useEffect(() => {
        ...
        const fetchCategory = async () => {
            try {
                const response = await axios.get(`https://goyat-dryfruits.onrender.com/api/signle-category/${id}`);
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            await axios.put(`https://goyat-dryfruits.onrender.com/api/update-category/${id}`, formData, {
                headers: {

...
const AllContactInquery = () => {
    ...
    useEffect(() => {
        const fetchContacts = async () => {
            try {
                const response = await axios.get('https://goyat-dryfruits.onrender.com/api/all-contacts');
    ...
    const handleDelete = async (id) => {
        try {
            const response = await axios.delete(`https://goyat-dryfruits.onrender.com/api/delete-contact/${id}`);

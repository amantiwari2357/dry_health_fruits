    ...
    useEffect(() => {
        const fetchTaxDetails = async () => {
            ...
            for (const product of order.products) {
                try {
                    const response = await axios.get(`https://goyat-dryfruits.onrender.com/api/single-product/${product.productId}`);
...
const EditOrder = () => {
    ...
    useEffect(() => {
        const fetchOrder = async () => {
            try {
                const response = await axios.get(`https://goyat-dryfruits.onrender.com/api/single-order-data/${orderId}`);
    ...
    const handleUpdate = async () => {
        try {
            const response = await axios.put(`https://goyat-dryfruits.onrender.com/api/update-order/${orderId}`, {
                orderStatus,
                paymentStatus,
            });
            if (response.data.success) {
    ...
    const handleLogin = async (e) => {
        ...
        try {
            const response = await axios.post('https://goyat-dryfruits.onrender.com/api/login-via-shiprocket', payload, {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const response = await axios.post('https://goyat-dryfruits.onrender.com/api/shiped-order-shiprocket', orderData, {
                headers: { 'Content-Type': 'application/json' }
            });
            console.log(response)
            if (response.status === 200) {

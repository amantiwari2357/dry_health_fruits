...
const EditPincode = () => {
    ...
    useEffect(() => {
        ...
        const fetchPincodeDetails = async () => {
            try {
                const response = await axios.get(`https://goyat-dryfruits.onrender.com/api/single-pincode/${id}`);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.put(`https://goyat-dryfruits.onrender.com/api/update-pincode/${id}`, pincodeData);

...
const AllProduct = () => {
    ...
    const handleDelete = async (productId) => {
        try {
            ...
            if (result.isConfirmed) {
                const response = await axios.delete(`https://goyat-dryfruits.onrender.com/api/delete-product/${productId}`);
    ...
    const handleStatusChange = async (productId, field, currentValue) => {
        try {
            const response = await axios.put(`https://goyat-dryfruits.onrender.com/api/update-product/${productId}`, {

...
const EditSubCategory = () => {
    ...
    useEffect(() => {
        const fetchCategories = async () => {
            try {
                const response = await axios.get('https://goyat-dryfruits.onrender.com/api/all-category');
        ...
        const fetchSubCategory = async () => {
            try {
                const response = await axios.get(`https://goyat-dryfruits.onrender.com/api/single-subcategory/${id}`);
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            const response = await axios.put(
                `https://goyat-dryfruits.onrender.com/api/update-subcategory/${id}`,
                apiFormData,
                {
                    headers: {

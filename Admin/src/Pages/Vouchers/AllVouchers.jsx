...
const AllVouchers = () => {
    ...
    useEffect(() => {
        const fetchVouchers = async () => {
            try {
                const response = await axios.get('https://goyat-dryfruits.onrender.com/api/all-vouchers');
    ...
    const handleDelete = async (id) => {
        try {
            ...
            if (result.isConfirmed) {
                await axios.delete(`https://goyat-dryfruits.onrender.com/api/delete-vouchers/${id}`);
